...
class EmployeeService{
    ...
    constructor(private emmployeeRepository:EmployeeRepository, private departmentRepository:DepartmentRepository){}
    async createEmployee(employeeId:string,dateOfJoining:Date,experience:number,status:Status,dept_id:number,email:string,name:string,age:number,address:CreateAddressDto,password:string,role:EmployeeRole):Promise<Employee>{
